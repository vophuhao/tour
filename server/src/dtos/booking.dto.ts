export class BookingDTO {
  static toResponse(booking: any) {
    ...
    return {
      ...
      dissatisfactionRequest: booking.dissatisfactionRequest ? {
        requestedAt: booking.dissatisfactionRequest.requestedAt,
        reason: booking.dissatisfactionRequest.reason,
        phone: booking.dissatisfactionRequest.phone,
        email: booking.dissatisfactionRequest.email,
        bankAccountName: booking.dissatisfactionRequest.bankAccountName,
        bankAccountNumber: booking.dissatisfactionRequest.bankAccountNumber,
        bankName: booking.dissatisfactionRequest.bankName,
        evidenceImages: booking.dissatisfactionRequest.evidenceImages,
        status: booking.dissatisfactionRequest.status,
        adminNote: booking.dissatisfactionRequest.adminNote,
        processedAt: booking.dissatisfactionRequest.processedAt,
        processedBy: booking.dissatisfactionRequest.processedBy,
        refundAmount: booking.dissatisfactionRequest.refundAmount,
      } : null,
